package com.saxion.proj.tfms.routing.service.assignment.helper.truckassignment.service;
...
@Service("TruckAssignmentServiceByBestFitAlgorithm")
public class TruckAssingmentAlgoServiceAlgoImpl implements TruckAssingmentAlgoService {
        ...
        try {
            ...
            for (Pair<String, Double> parcel : parcels) {
                ...
                if (bestTruck != null) {
                    ...
                    bestTruck.addParcel(new TruckAssignment.ParcelInfo(parcelId, volume));
                } else {
    ...
    private static class TruckState {
        ...
        private final List<TruckAssignment.ParcelInfo> parcels;
        ...
        public void addParcel(TruckAssignment.ParcelInfo parcel) {
            parcels.add(parcel);
        ...
        public List<TruckAssignment.ParcelInfo> getParcels() {
            return parcels;
        }
