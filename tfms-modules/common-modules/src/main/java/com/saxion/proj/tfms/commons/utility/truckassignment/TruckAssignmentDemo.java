package com.saxion.proj.tfms.commons.utility.truckassignment;
...
import com.saxion.proj.tfms.commons.utility.truckassignment.service.TruckAssignmentService;
import com.saxion.proj.tfms.commons.utility.truckassignment.service.TruckAssignmentServiceImpl;
...
public class TruckAssignmentDemo {
    ...
    private static void testSuccessfulAssignment() {
        ...
        TruckAssignmentService service = new TruckAssignmentServiceImpl();
    ...
    private static void testPartialAssignment() {
        ...
        if (response.isSuccess() && !response.hasUnassignedParcels()) {
            ...
            for (TruckAssignment assignment : response.getTruckAssignments()) {
                System.out.println("    " + assignment.getTruckId() + ":");
                for (ParcelInfo parcel : assignment.getParcels()) {
    ...
    private static void testBestFitAlgorithm() {
        ...
        if (response.isSuccess() && !response.hasUnassignedParcels()) {
            ...
            for (TruckAssignment assignment : response.getTruckAssignments()) {
                ...
                for (ParcelInfo p : assignment.getParcels()) {
