...
//        when(parcelRepository.findByStatusAndPlannedDeliveryDate(eq(StatusEnum.SCHEDULED), any(), any(), eq(pageable)))
//                .thenReturn(mockPage);
//
...
//        verify(parcelRepository).findByStatusAndPlannedDeliveryDate(eq(StatusEnum.SCHEDULED), any(), any(), eq(pageable));
//    }
//
...
//        when(parcelRepository.findByStatusAndPlannedDeliveryDate(any(), any(), any(), eq(pageable)))
//                .thenReturn(mockPage);
//
//        handler.Handle(sunday, 0, 5);
//
//        verify(parcelRepository, times(1)).findByStatusAndPlannedDeliveryDate(any(), any(), any(), any());
//    }
//
